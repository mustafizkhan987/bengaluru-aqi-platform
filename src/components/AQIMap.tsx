              ...
              <Popup>
                <div className="font-sans">
                  ...
                  <div className="mt-2 text-xs text-gray-600 space-y-1">
                    <p>PM2.5: <span className="font-medium">{data.latestReading.pm25.toFixed(1)}</span> µg/m³</p>
                    <p>PM10: <span className="font-medium">{data.latestReading.pm10.toFixed(1)}</span> µg/m³</p>
                  </div>
                </div>
              </Popup>
            </CircleMarker>
