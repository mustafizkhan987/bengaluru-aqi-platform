...
interface DashboardClientProps {
  ...
  initialDrivers: ExplanationResult | null;
}

export function DashboardClient({ initialStations, initialSelectedStation, initialHistorical, initialDrivers }: DashboardClientProps) {
  ...
  const [latestReading, setLatestReading] = useState<Reading | null>(initialHistorical[0] || null);
  const [drivers, setDrivers] = useState<ExplanationResult | null>(initialDrivers);
