...
export default function SimulatorPage() {
  ...
  const [baseAqi, setBaseAqi] = useState<number>(0);
  ...
  const [simResult, setSimResult] = useState<{ result: SimulationResult, scenarios: Array<{ name: string, description: string, baseAqi: number, newAqi: number, adjustments: Record<string, number> }> } | null>(null);
  ...
  useEffect(() => {
    ...
    runSim();
  }, [deferredReductions, baseInput, initialLoading]);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="bg-graphite border border-carbon p-6 md:p-10 rounded-2xl transition-colors duration-300">
            ...
            {initialLoading ? (
              <div className="skeleton-shimmer h-32 rounded bg-obsidian border border-carbon"></div>
            ) : !simResult ? (
